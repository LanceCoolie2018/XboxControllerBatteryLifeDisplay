...
- [ ] needs added button for bug report that will add a line to the open issues in the UserReport.md so that the user doesnt need to open code to notify of an issue.
